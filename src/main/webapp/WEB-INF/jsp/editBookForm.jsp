...
<form:form name="editBookForm" commandName="book" method="post"
	...
	<table>
		<tr>
			...
			<td><font style="color: #C11B17;"><form:errors path="name" /></font></td>
		</tr>
		<tr>
			<td>Author:<font style="color: #C11B17;">*</font></td>
			<td><form:input path="author" /></td>
			<td><font style="color: #C11B17;"><form:errors	path="author" /></font></td>
		</tr>
		<tr>
			<td>ISBN:<font style="color: #C11B17;">*</font></td>
			<td><form:input path="isbnNumber" readonly="true"/></td>
			<td><font style="color: #C11B17;"><form:errors path="isbnNumber" /></font></td>
		</tr>
	</table>
	<table align="right">
		<tr>
